...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // Enhanced activity logging for all web routes
        ...
        // Secure web routes with enhanced security
        'secure_web' => [
            \Illuminate\Cookie\Middleware\EncryptCookies::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            \Illuminate\Session\Middleware\StartSession::class,
        ...
        // Auth routes without activity logging to avoid conflicts
        'auth_web' => [
            \Illuminate\Cookie\Middleware\EncryptCookies::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            \Illuminate\Session\Middleware\StartSession::class,
    ...
    protected $middlewareAliases = [
        ...
        'password.check' => \App\Http\Middleware\PasswordCheckMiddleware::class,
        
        // Rate limiting aliases
        'throttle.login' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':login',
        'throttle.password-reset' => \Illuminate\Routing\Middleware\ThrottleRequests::class.':password-reset',
        
        // Two-factor authentication (for future use)
        'two-factor' => \App\Http\Middleware\TwoFactorMiddleware::class,
        
        // Security audit middleware
        'audit' => \App\Http\Middleware\SecurityAuditMiddleware::class,
    ];
}